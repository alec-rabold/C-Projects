...
main()
{
    ...
    */
    ...
    /* This second logical statement uses the OR operator to test
       ...
       months in the year. If either statement is true, then the
       statement will print.
    */

    if ((starWars <= months) || (potterBooks <= months))
    {
        printf("\nYou could read one Harry Potter book a months,\n");
    ...
    /* This final logical statement uses the NOT operator to test
       ...
       the number of basketball players on a team is NOT greater
       than the number of football players on a team. If so, the
